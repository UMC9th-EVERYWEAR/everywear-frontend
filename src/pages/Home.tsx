		...
		<div className="flex flex-col w-full bg-white pb-10">
			...
			<section className="flex gap-3 px-5 py-4 overflow-x-auto no-scrollbar">
				{[1, 2, 3, 4].map((i) => (
					<div
						key={i}
						className="min-w-[75px] h-[75px] bg-[#D2D2D2] rounded-[6px] flex items-center justify-center"
					>
			...
			<section className="px-5 mt-10">
				...
				<div className="grid grid-cols-2 gap-4">
					{[1, 2].map((i) => (
						<div
							key={i}
							className="w-[137px] h-[182px] bg-[#D2D2D2] rounded-[10px] flex items-center justify-center"
						>
