    ...
    <div className='flex flex-col w-full bg-white pb-10 min-h-[calc(100vh-101px)]'>
      ...
      <section className="mt-10">
        ...
        >
          {isProductLoading ? (
            [1, 2, 3].map((i) => (
              <div key={i} className="min-w-[140px] h-[200px] bg-neutral-100 rounded-[10px] animate-pulse" />
            ))
            ...
            productsList.map((product: any) => (
              <div key={product.product_id || product.productId} className="min-w-[140px] shrink-0">
                <ProductCard 
                  ...
                  imageUrl={product.product_img_url || product.product_image_url || product.imageUrl}
                  rating={product.star_point || product.rating || 0}
                />
              </div>
            ))
          ) : (
      ...
      <section className="mt-12 pb-10">
        ...
        >
          {isFittingLoading ? (
            [1, 2, 3].map((i) => (
              <div key={i} className="min-w-[137px] h-[182px] bg-neutral-100 rounded-[10px] animate-pulse" />
            ))
