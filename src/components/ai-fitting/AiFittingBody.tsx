	...
	return (
		<>
			...
			>
				...
				<div className='h-[473px] w-full px-[10px] py-4 flex flex-col items-center border rounded-xl border-neutral-200 justify-between'>
					{/* 피팅 전 사진 */}
					<img
						className='border border-none rounded-xl h-[385px] w-[80%] flex items-center'
						src={imageUrlExample}
						alt='피팅 전 사진'
					/>
			...
			<div className='w-full flex flex-col items-center justify-between mb-[34px] h-[1096px]'> 
				...
				<div className='h-[108px] w-full flex flex-col justify-between items-center'>
					...
					>재생성하기</button>
					<button
						className='h-11 border border-none bg-neutral-400 
